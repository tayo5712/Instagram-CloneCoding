...
//import com.cos.photogramstart.config.oauth.KakaoService;
...
//    public String kakaoCallback(String code) throws JsonProcessingException { // Data를 리턴해주는 컨트롤러 함수
...
//        kakaoService.카카오로그인(kakaoProfile);
//        return "redirect:/";
//    }
}
